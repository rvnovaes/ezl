    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date',
                 models.DateTimeField(
                     null=True, verbose_name='Data de Início')),
                ('latitude',
                 models.DecimalField(
                     blank=True,
                     decimal_places=6,
                ...
                ('alter_user',
                 models.ForeignKey(
                     ...
                     related_name='taskgeolocation_alter_user',
                     to=settings.AUTH_USER_MODEL,
                     verbose_name='Alterado por')),
                ('create_user',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.PROTECT,
                     related_name='taskgeolocation_create_user',
                     to=settings.AUTH_USER_MODEL,
                ...
                ('checkpointtype',
                 models.CharField(
                     choices=[('Checkin', 'Checkin'), ('Checkout',
                                                       'Checkout')],
                     default=task.models.CheckPointType('Checkin'),
                     max_length=10,
                     null=True,

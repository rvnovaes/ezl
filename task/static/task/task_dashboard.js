var getColumns = function(status) {
    ...
    if (status === 'Erro no sistema de origem') {
        ...
        columns[10] = {'data': 'inconsistencyetl__inconsistency', 'name': 'inconsistencyetl__inconsistency'};
        columns[11] = {'data': 'inconsistencyetl__solution', 'name': 'inconsistencyetl__solution'};
    } else {
        columnDefs = [

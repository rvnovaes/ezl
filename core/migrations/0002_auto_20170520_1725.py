...
class Migration(migrations.Migration):
    ...
    operations = [
        migrations.AddField(
            model_name='city',
            name='court_district',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, to='lawsuit.CourtDistrict', verbose_name='Comarca'),
        ),
        migrations.AddField(
            model_name='city',
            name='create_user',
        ...
        migrations.AddField(
            ...
            name='alter_user',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='addresstype_alter_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='addresstype',
            name='create_user',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='addresstype_create_user', to=settings.AUTH_USER_MODEL),
        ),
        migrations.AddField(
            model_name='address',
            name='address_type',

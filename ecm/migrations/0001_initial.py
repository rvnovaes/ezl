    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('model_name',
                 models.CharField(max_length=120, verbose_name='Model')),
                ('object_id',
                 models.PositiveSmallIntegerField(
                     db_index=True, verbose_name='ID do Registro')),
                ('file',
                 models.FileField(
                     upload_to=ecm.models.get_uploda_to,
                     verbose_name='Arquivo')),
                ('create_user',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.PROTECT,
                     related_name='attachment_create_user',
            ...
            fields=[
                ...
                ('alter_user',
                 models.ForeignKey(
                     ...
                     null=True,
                     on_delete=django.db.models.deletion.PROTECT,
                     related_name='defaultattachmentrule_alter_user',
                     to=settings.AUTH_USER_MODEL,
                ...
                ('create_user',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.PROTECT,
                     related_name='defaultattachmentrule_create_user',
                     to=settings.AUTH_USER_MODEL,
                     verbose_name='Criado por')),
                ('office',
                 models.ForeignKey(
                     on_delete=django.db.models.deletion.PROTECT,
                     related_name='defaultattachmentrule_office',
                     to='core.Office',

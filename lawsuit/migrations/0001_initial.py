    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('alter_user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT,
                                                 related_name='courtdistrict_alter_user', to=settings.AUTH_USER_MODEL)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('person_court',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='movement_court',
                                   to='core.Person')),
                ('person_lawyer',
                 models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='movement_lawyer',
                                   to='core.Person')),
            ],
            options={
                'db_table': 'movement',

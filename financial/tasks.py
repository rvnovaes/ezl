...
def row_is_valid(office_correspondent, policy_price, type_task, state, row_errors):
    return all([office_correspondent, policy_price, type_task, state, not row_errors])
    ...
    try:
        ...
        for sheet in wb.worksheets:
            ...
            for row in sheet.iter_rows(min_row=2):
                ...
                if row_is_valid(office_correspondent, policy_price, type_task, state, row[len(row) - 1]['errors']):

        ...
        for row in sheet.iter_rows(min_row=2):                       
            ...
            if office_name != '':                
                ...
                if office_correspondent is None:
                    errors.append('Escritório correspondente %s não encontrado' % office_name)                    
                    importar = False                    
            ...
            if nome_servico != '':
                ...
                if type_task is None:
                    errors.append('Tipo de serviço %s não encontrado' % nome_servico)
                    importar = False                    
            ...
            if sigla_uf != '':
                ...
                if state is None:
                    errors.append('UF %s não encontrada' % sigla_uf)                    
                    importar = False
